...
* Utilizes safely enclosed names and gracefully skips entries with invalid or potentially malicious paths, preventing runtime panics and unauthorized directory traversals. [#35](https://github.com/matzefriedrich/zip-extensions-rs/pull/35)
...
* :see_no_evil: Fixes interchanged modules names (inflate vs deflate) [#33](https://github.com/matzefriedrich/zip-extensions-rs/pull/33)
